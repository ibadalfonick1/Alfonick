...
<section className="-mt-24 mx-5 rounded-[20px] -z-9 relative overflow-hidden bg-black pt-35! pb-20">
    ...
    blur-[80px] opacity-90 -z-99"></div>
        ...
        <span className="bg-[#750200ad] border-2 border-white/30 shadow-[0_-1px_7px_1px_#B81C15] text-[#B81C15]! sm:text-[16px] text-[14px] text:font-bold uppercase block text-center italic m-auto px-6 py-2 w-fit rounded-4xl mb-1 z-99">
          {" "}
          Our Gallery{" "}
        </span>
