      ...
      <section>
        <div className="mx-3 rounded-2xl bg-[#EEEEEE] py-20!">
          <div className="pb-5 xl:[&>h2]:text-[50px] lg:[&>h2]:text-[46px] sm:[&>h2]:text-[36px] [&>h2]:mt-4 [&>h2]:text-[30px] sm:[&>h2]:pt-0 [&>h2]:pt-5 [&>h2]:leading-[1.1] [&>h2_span]:text-[#B81C15] [&>h2_span]:italic text-center [&>span]:px-6 [&>span]:py-3 [&>span]:italic [&>span]:rounded-4xl [&>span]:bg-[#B81C15]/5 [&>span]:text-[#B81C15]">            
            ...
            <h2>
              Our 4 Stage <span className="block"> Process</span>
            </h2>
          </div>
            ...
            <div className="flex md:gap-8 gap-4 mb-35 relative before:content-[''] before:absolute before:left-11 before:top-28 before:h-full before:w-1 before:bg-linear-to-b before:from-white before:to-[#e4837f] px-4">
              ...
              <div className="bg-white rounded-[30px] md:p-8 p-5 [&>span]:text-[#B81C15] [&>span]:font-bold! [&>span]:text-[16px] [&>span]:uppercase [&>h3]:text-2xl [&>h3]:font-semibold! [&>h3]:pt-4 [&>h3]:pb-2 [&>p]text-[16px] [&>p]:text-[#22222299]">
                ...
                <p>
                  ...
                  necessary adjustments to optimize results. This iterative
                  process allows us to adapt to changes in the market and
