  ...
  return (
    <>
      ...
      <form action="" className="max-w-227 mx-auto sm:mb-40 mb-32 px-4">
        <div className=" px-8 pt-7 pb-10 bg-[#FFFFFF40] rounded-2xl ">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 ">
            <div className="[&>label]:block [&>label]:mb-3">
        ...
        <div className="flex justify-center mt-6">
          <button
            type="submit"
            className="relative rounded-full bg-white text-black py-3 pr-8 pl-12 uppercase cursor-pointer before:content-[''] before:absolute before:left-5 before:top-1/2 before:-translate-y-1/2 before:w-2 before:h-2 before:bg-black before:rounded-full"
          >
            Send Message
          </button>
