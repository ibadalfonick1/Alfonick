...
export default function AboutWhyChoose() {
  return (
    <section className="pt-22 pb-10 px-4 md:px-16">
      <div className="pb-5 xl:[&>h2]:text-[50px] lg:[&>h2]:text-[46px] sm:[&>h2]:text-[36px] [&>h2]:mt-4 [&>h2]:text-[30px] sm:[&>h2]:pt-0 [&>h2]:pt-5 [&>h2]:leading-[1.1] [&>h2>span]:text-[#B81C15] [&>h2>span]:italic text-center [&>span]:px-6 [&>span]:py-3 [&>span]:italic [&>span]:uppercase [&>span]:rounded-4xl [&>span]:bg-[#B81C15]/5 [&>span]:text-[#B81C15]">
        
        <span>Built For Intelligent</span>

        <h2>
          Why Choose{" "}
          <span className="block">Alfonick International</span>
        </h2>
      </div>
