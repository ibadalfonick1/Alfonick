...
const OurCulture = () => {
  return (
    <section className="bg-[url('/images/Culture.webp')] bg-cover bg-center bg-no-repeat pt-10 lg:pb-45 sm:pb-40 pb-20">
      ...
      <div className="container grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4 [&_div]:bg-[#FFFFFF40] [&_div]:px-3 [&_div]:py-5 [&_div]:rounded-2xl [&_div_h3]:font-bold! [&_div_h3]:text-[96px] [&_div_h3]:text-white! [&_div_h3]:font-[inter]! [&_div_h3]:leading-[0.8] [&_div_h3]:mb-20 lg:[&_div_h3]:mb-30 [&_div_strong]:font-[inter]! [&_div_strong]:text-[24px] [&_div_strong]:font-bold! [&_div_strong]:mb-2 [&_div_strong]:block [&_div_strong]:text-white [&_div_p]:text-white [&_div_p]:font-[inter]! [&_div_p]:text-[16px] [&_div]:h-full">
